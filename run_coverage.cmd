...
.\tools\OpenCover.4.6.519\tools\OpenCover.Console.exe -target:.\tools\NUnit.Runners.3.4.1\tools\nunit-console.exe -targetargs:"/nologo /noshadow .\Alfred.Tests\bin\Release\Alfred.Tests.dll" -filter:"+[*]* -[*.Tests]*" -register:user
