...
.\tools\OpenCover.4.6.519\tools\OpenCover.Console.exe -target:.\tools\NUnit.ConsoleRunner.3.4.1\tools\nunit3-console.exe -targetargs:".\Alfred.Tests\bin\Release\Alfred.Tests.dll .\Alfred.Model.Implementation.Tests\bin\Release\Alfred.Model.Implementation.Tests.dll" -filter:"+[Alfred*]* -[*.Tests]*" -register:user
